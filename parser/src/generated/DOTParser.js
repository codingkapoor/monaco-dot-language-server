...
function GlobalAttrStmtContext(parser, ctx) {
	StmtContext.call(this, parser);
    StmtContext.prototype.copyFrom.call(this, ctx);
    return this;
}

GlobalAttrStmtContext.prototype = Object.create(StmtContext.prototype);
GlobalAttrStmtContext.prototype.constructor = GlobalAttrStmtContext;

DOTParser.GlobalAttrStmtContext = GlobalAttrStmtContext;

GlobalAttrStmtContext.prototype.id = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
GlobalAttrStmtContext.prototype.enterRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.enterGlobalAttrStmt(this);
	}
};

GlobalAttrStmtContext.prototype.exitRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.exitGlobalAttrStmt(this);
	}
};


function NodeStmtContext(parser, ctx) {
	StmtContext.call(this, parser);
    StmtContext.prototype.copyFrom.call(this, ctx);
    return this;
}

NodeStmtContext.prototype = Object.create(StmtContext.prototype);
NodeStmtContext.prototype.constructor = NodeStmtContext;

DOTParser.NodeStmtContext = NodeStmtContext;

NodeStmtContext.prototype.node_stmt = function() {
    return this.getTypedRuleContext(Node_stmtContext,0);
};
NodeStmtContext.prototype.enterRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.enterNodeStmt(this);
	}
};

NodeStmtContext.prototype.exitRule = function(listener) {
    if(listener instanceof DOTListener ) {
...
function EdgeStmtContext(parser, ctx) {
	StmtContext.call(this, parser);
    StmtContext.prototype.copyFrom.call(this, ctx);
    return this;
}

EdgeStmtContext.prototype = Object.create(StmtContext.prototype);
EdgeStmtContext.prototype.constructor = EdgeStmtContext;

DOTParser.EdgeStmtContext = EdgeStmtContext;

EdgeStmtContext.prototype.edge_stmt = function() {
    return this.getTypedRuleContext(Edge_stmtContext,0);
};
EdgeStmtContext.prototype.enterRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.enterEdgeStmt(this);
	}
};

EdgeStmtContext.prototype.exitRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.exitEdgeStmt(this);
	}
};


function AttrStmtContext(parser, ctx) {
	StmtContext.call(this, parser);
    StmtContext.prototype.copyFrom.call(this, ctx);
    return this;
}

AttrStmtContext.prototype = Object.create(StmtContext.prototype);
AttrStmtContext.prototype.constructor = AttrStmtContext;

DOTParser.AttrStmtContext = AttrStmtContext;

AttrStmtContext.prototype.attr_stmt = function() {
    return this.getTypedRuleContext(Attr_stmtContext,0);
};
AttrStmtContext.prototype.enterRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.enterAttrStmt(this);
	}
};

AttrStmtContext.prototype.exitRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.exitAttrStmt(this);
	}
};


function SubgraphStmtContext(parser, ctx) {
	StmtContext.call(this, parser);
    StmtContext.prototype.copyFrom.call(this, ctx);
    return this;
}

SubgraphStmtContext.prototype = Object.create(StmtContext.prototype);
SubgraphStmtContext.prototype.constructor = SubgraphStmtContext;

DOTParser.SubgraphStmtContext = SubgraphStmtContext;

SubgraphStmtContext.prototype.subgraph = function() {
    return this.getTypedRuleContext(SubgraphContext,0);
};
SubgraphStmtContext.prototype.enterRule = function(listener) {
    if(listener instanceof DOTListener ) {
        listener.enterSubgraphStmt(this);
	}
};

SubgraphStmtContext.prototype.exitRule = function(listener) {
    if(listener instanceof DOTListener ) {
...
DOTParser.prototype.stmt = function() {
    ...
    try {
        ...
        switch(la_) {
        case 1:
            localctx = new NodeStmtContext(this, localctx);
            this.enterOuterAlt(localctx, 1);
            this.state = 48;
            this.node_stmt();
            break;
        ...
        case 2:
            localctx = new EdgeStmtContext(this, localctx);
        ...
        case 3:
            localctx = new AttrStmtContext(this, localctx);
        ...
        case 4:
            localctx = new GlobalAttrStmtContext(this, localctx);
        ...
        case 5:
            localctx = new SubgraphStmtContext(this, localctx);
